...
// Register redis
export const redisClient = new RedisClient(RedisClientType.NORMAL, process.env.REDIS_HOST, process.env.REDIS_PASSWORD, Number(process.env.REDIS_PORT), 5, 'GH_Controller')
redisClient.registerEvent('end', new EndEvent())

export const redisSubscribe = new RedisClient(RedisClientType.SUBSCRIBER, process.env.REDIS_HOST, process.env.REDIS_PASSWORD, Number(process.env.REDIS_PORT), 5, 'GH_Controller_SUB')
